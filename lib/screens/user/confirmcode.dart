...
import 'package:zwajib/screens/user/infocount.dart';
import 'package:zwajib/screens/typeacount.dart';
...
class _confirmcodeScreenState extends State<confirmcodeScreen> {
    ...
    TextEditingController codeconfuser = new TextEditingController();

 @override
  void initState() {
    super.initState();
    codeconfuser.addListener(_printLatestValue);
  }

  @override
  void dispose() {
    codeconfuser.dispose();
    super.dispose();
  }

  void _printLatestValue() {
    print('please Enter your code: ${codeconfuser.text}');
  }
  @override
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => infocountScreen()),
                                    );
                                  },
