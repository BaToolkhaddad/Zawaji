...
class searchOrdinaryScreen extends StatefulWidget {
  const searchOrdinaryScreen({Key? key}) : super(key: key);

  @override
  _searchOrdinaryScreenState createState() =>
      _searchOrdinaryScreenState();
}

class _searchOrdinaryScreenState
    extends State<searchOrdinaryScreen> {
