...
import 'package:zwajib/screens/khataba/infocertificatekhataba.dart';




class infoLocationKhatabaScreen extends StatefulWidget {
  const infoLocationKhatabaScreen({Key? key}) : super(key: key);

  @override
  _infoLocationKhatabaScreenState createState() => _infoLocationKhatabaScreenState();
}

class _infoLocationKhatabaScreenState extends State<infoLocationKhatabaScreen> {
 
   String dropdownValuearea = '';
  List<String> readsarea = [ 'جدة', 'الدمام', 'الرياض', ''];

  String dropdownValuenation='';
  List<String> readsn =[''];
  
 String? dropdownValuena;
  SelectorDetails? selectorDropDownValuena;
 ...
 Widget build(BuildContext context) {
    ...
    return Form(
      child: FutureBuilder(
          future: Future.wait(
              [selectorDetails.getSelectorDetails('partnernationality'),
              ]),
                                    ...
                                    children: [
                                      Container(
                                          ...
                                          height: MediaQuery.of(context)
                                              ...
                                              .1,
                                          child: Text(
                                            'معلومات السكن و الجنسية للخطابة',
                                          ...
                                          Container(
                                              ...
                                              child: DropdownButton<SelectorDetails>(
                                                ...
                                                onChanged: (SelectorDetails? newValue) {
                                                  setState(() {
                                                     selectorDropDownValuena = newValue!;
                                                  });
                                                   selectorDropDownValuena == null ?"" : newValue;
                                                },
 ...
 SizedBox(
                                    ...
                                    mainAxisAlignment: MainAxisAlignment.center,
                                           children: [
                                              Text('هل أنت مقيم' ,  style: TextStyle(color: Colors.black  ,fontSize: 15 ),),
                                             IconButton(
